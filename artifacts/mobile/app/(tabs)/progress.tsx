...
const styles = StyleSheet.create({
  ...
  overviewTitle: { fontSize: 14, fontFamily: "Inter_500Medium", color: "rgba(255,255,255,0.6)", marginBottom: 16 },
  ...
  overviewValue: { fontSize: 22, fontFamily: "Inter_700Bold", color: "#FFF", letterSpacing: -0.5 },
  overviewLabel: { fontSize: 11, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.5)" },
  ...
  periodTabActive: {},
  periodTabText: { fontSize: 12, fontFamily: "Inter_500Medium" },
  ...
  goalMeta: { fontSize: 12, fontFamily: "Inter_400Regular", marginTop: 2 },
  completedBadge: {},
});

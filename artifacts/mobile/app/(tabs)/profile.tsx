...
const styles = StyleSheet.create({
  ...
  profileEmail: { fontSize: 14, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.7)" },
  ...
  profileBadgeText: { fontSize: 12, fontFamily: "Inter_500Medium", color: "#FFF" },
  editNameWrap: { width: "100%" },
  editNameInput: { fontSize: 22, fontFamily: "Inter_700Bold", color: "#FFF", textAlign: "center", borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.4)", paddingBottom: 4 },
  ...
  bodyValue: { fontSize: 18, fontFamily: "Inter_700Bold" },
  bodyLabel: { fontSize: 11, fontFamily: "Inter_400Regular" },
  editBodyRow: { flexDirection: "row", gap: 16 },
  editBodyField: { flex: 1, gap: 6 },
  editBodyInput: { borderWidth: 1, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 10, fontSize: 15, fontFamily: "Inter_400Regular" },
  ...
  achIcon: { fontSize: 28 },
  achTitle: { fontSize: 12, fontFamily: "Inter_600SemiBold", textAlign: "center" },
  achDesc: { fontSize: 10, fontFamily: "Inter_400Regular", textAlign: "center" },

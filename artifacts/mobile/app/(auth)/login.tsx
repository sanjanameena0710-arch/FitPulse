...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 32, fontFamily: "Inter_700Bold", color: "#FFF", letterSpacing: -1 },
  subtitle: { fontSize: 15, fontFamily: "Inter_400Regular", color: "rgba(255,255,255,0.5)", marginTop: 8 },
  form: { gap: 16 },
  inputGroup: { gap: 8 },
  label: { fontSize: 14, fontFamily: "Inter_500Medium", color: "rgba(255,255,255,0.7)" },
  inputWrap: {
  ...
  forgotText: { fontSize: 13, fontFamily: "Inter_500Medium", color: "#6C63FF" },
  ...
  demoBtnText: { fontSize: 14, fontFamily: "Inter_500Medium", color: "#6C63FF" },
  ...
  footerLink: { fontSize: 14, fontFamily: "Inter_600SemiBold", color: "#6C63FF" },
});
